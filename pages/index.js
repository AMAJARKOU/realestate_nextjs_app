...
export default function Home({propertiesForSale, propertiesForRent}) {
  return (
    <Box>
      ...
      />
      <Flex flexWrap={"wrap"}>
        {propertiesForRent.map((property) => <Property key={property.externalID} property={property} />)}
      </Flex>
      <Banner
      purpose='BUY A HOME'
    ...
    />
    <Flex flexWrap={"wrap"}>
        {propertiesForSale.map((property) => <Property key={property.externalID} property={property} />)}
      </Flex>
    </Box>
  )
}
